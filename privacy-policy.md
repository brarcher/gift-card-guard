# PRIVACY POLICY FOR GIFT CARD GUARD

This privacy policy governs your use of the software application Gift Card Guard (“Application”) for mobile devices
that was created by Protect. The Application is designed to store and display gift card information.

# What information does the Application obtain and how is it used?

The Application allows a user to create gift card entries and record the card ID as well as the remaining
value of the card. When a store is later selected the corresponding data is displayed. 
This user data remains on the device and is not transmitted off of the device.
